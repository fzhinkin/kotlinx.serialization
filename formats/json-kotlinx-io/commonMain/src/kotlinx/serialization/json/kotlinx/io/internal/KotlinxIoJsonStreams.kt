...
package kotlinx.serialization.json.kotlinx.io.internal
...
internal class JsonToOkioStreamWriter(private val sink: Sink) : InternalJsonWriter {
...
internal class OkioSerialReader(private val source: Source): InternalJsonReader {
    /*
